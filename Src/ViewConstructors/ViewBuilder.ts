...
export abstract class ViewBuilder {
	public abstract render(newRender?: ViewBuilder, withAnimatiom?: boolean, ...param: any[]): HTMLElement
	public abstract destroy(withAnimatiom?: boolean, ...param: any[]): void | Promise<void>
